...
create_ui <- function(
  ...
  lock_r("ui")
  if (!quiet) cli_alert_success("Creating {.file R/ui.R}")
...
create_server <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file R/server.R}")
...
create_assets <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file R/assets.R}")
...
create_onload <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file R/zzz.R}")
...
create_run <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file R/run.R}")
...
create_utils <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file R/leprechaun-utils.R}")
...
create_dir_img <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file inst/img}")
...
create_dir_assets <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file inst/assets}")
...
create_dir_dev <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file inst/dev}")
...
create_dir_run <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file inst/run/app.R}")
...
create_disable_autoload <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file R/_disable_autoload.R}")
...
create_input_handlers <- function(quiet = FALSE) {
  ...
  if (!quiet) cli_alert_success("Creating {.file R/input-handlers.R}")
